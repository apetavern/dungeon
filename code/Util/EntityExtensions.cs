...
public static class EntityExtensions
{
	...
	{
		self.SetupPhysicsFromAABB( motionType, new Vector3( -boundsSize, -boundsSize, 0 ), new Vector3( boundsSize, boundsSize, Map.CellHeight ) );
	}
	...
	{
		return new BBox( new Vector3( -boundsSize, -boundsSize, 0 ), new Vector3( boundsSize, boundsSize, Map.CellHeight ) );
	}
}
